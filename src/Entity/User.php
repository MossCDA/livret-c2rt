...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Booklet::class)]
    ...
    private Collection $formationsAsFormateur;

    public function __construct()
    {
        $this->booklets = new ArrayCollection();
        $this->slots = new ArrayCollection();
        $this->formationsAsFormateur = new ArrayCollection();
    }
    ...
    public function getFormationsAsFormateur(): Collection { return $this->formationsAsFormateur; }
}